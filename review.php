...
$DATABASE_USER = 'epiz_28719055';
$DATABASE_PASS = 'LunaticBrain';
$DATABASE_NAME = 'epiz_28719055_mydatabase';
try {
...
if (isset($_GET['page_id'])) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM reviews WHERE page_id = ? ORDER BY submit_date ASC');
